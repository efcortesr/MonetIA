...
import { loginAction, googleAuthAction } from "@/app/actions/auth-actions";
...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Re-initialize if the script has already loaded
    if (typeof window !== "undefined" && window.google) {
      ...
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-zinc-200/80 bg-white p-8 shadow-xl backdrop-blur-sm sm:p-10">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-sm text-zinc-500">
            Inteligencia financiera a tu alcance
          </p>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs">
          <div className="w-full max-w-sm rounded-2xl border border-zinc-200 bg-white p-6 shadow-2xl animate-fade-in">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="mt-4 text-lg font-bold text-zinc-900">Iniciar sesión con Google</h2>
            ...
            <div className="mt-6 space-y-2">
              <button
                ...
                className="flex w-full items-center gap-3 rounded-xl border border-blue-100 bg-blue-50/20 p-3 text-left text-sm hover:bg-blue-50/40 transition-colors cursor-pointer"
              >
                <div className="grid h-8 w-8 place-items-center rounded-full bg-blue-600 text-xs font-bold text-white">
                  SA
                </div>
                <div className="flex-1 min-w-0">
                  <div className="font-semibold text-zinc-900 truncate">Sara Arango</div>
                  <div className="text-xs text-blue-600 font-medium truncate">sarangoe3@afit.edu.co (Proyectos)</div>
                </div>
              </button>
              ...
              >
                <div className="grid h-8 w-8 place-items-center rounded-full bg-zinc-200 text-xs font-bold text-zinc-700">
                  ID
                </div>
                <div className="flex-1 min-w-0">
